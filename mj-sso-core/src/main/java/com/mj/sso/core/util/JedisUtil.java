...
public class JedisUtil {
    ...
    /**
     * redis address, like "{ip}"、"{ip}:{port}"、"{redis/rediss}://mj.sso:{password}@{ip}:{port:6379}/{db}"；Multiple "," separated
     */
    ...
    private static ShardedJedis getInstance() {
                ...
                if (INSTANCE_INIT_LOCL.tryLock(2, TimeUnit.SECONDS)) {
                    ...
                    try {
                        ...
                        if (shardedJedisPool == null) {
                            ...
                            logger.info(">>>>>>>>>>> mj-sso, JedisUtil.ShardedJedisPool init success.");
                        }
        ...
        if (shardedJedisPool == null) {
            throw new NullPointerException(">>>>>>>>>>> mj-sso, JedisUtil.ShardedJedisPool is null.");
        }
    ...
    public static void main(String[] args) {
        String xxlSsoRedisAddress = "redis://mj.sso:password@127.0.0.1:6379/0";
