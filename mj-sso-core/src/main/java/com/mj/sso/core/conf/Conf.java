...
public class Conf {
     ...
     */
    public static final String SSO_SESSIONID = "mj_sso_sessionid";
     ...
     */
    public static final String SSO_USER = "mj_sso_user";
    ...
    public static final String  WX_REDIRECTURI = "wx_redirecturi";
